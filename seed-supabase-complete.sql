-- =============================================
-- SCHEMA FIX + SEED DATA COMPLETO
-- Talleres Pro - Supabase
-- =============================================
-- 1) Ejecutar este script completo en SQL Editor de Supabase
-- 2) Si falla por duplicados, ejecutar primero la sección de LIMPIEZA
-- =============================================

-- =============================================
-- INSTRUCCIONES
-- 1) Si querés limpiar TODO antes de cargar, ejecutá este bloque PRIMERO en otra pestaña del SQL Editor:
/*
DO $$
DECLARE
    r RECORD;
BEGIN
    FOR r IN (SELECT tablename FROM pg_tables WHERE schemaname = 'public' AND tablename IN ('detalle_ventas','ventas','pedidos','presupuestos','movimientos_stock','ordenes_servicio','tareas_servicio','subservicios','servicios','productos','categorias','marcas','proveedores','clientes','usuarios','cajas','movimientos_caja','cuotas','planes_credito','formas_pago','notificaciones','configuracion_alertas','auditoria','menu_online_config','productos_destacados','historial_compras_cliente','sugerencias_venta','configuracion_recurrente','configuracion','compras','facturas_electronicas','campanias','depositos','unidades'))
    LOOP
        EXECUTE 'DELETE FROM ' || quote_ident(r.tablename);
    END LOOP;
END $$;
*/
-- 2) Después ejecutá este script completo.
-- =============================================
...
-- 2. USUARIOS (password = SHA256 de 'admin123')
...
-- 6. UNIDADES
INSERT INTO unidades (id, nombre, abreviatura, activo) VALUES
  ('u1111111-1111-1111-1111-111111111111', 'Unidad', 'u', true),
  ('u2222222-2222-2222-2222-222222222222', 'Litro', 'L', true),
  ('u3333333-3333-3333-3333-333333333333', 'Kilogramo', 'kg', true),
  ('u4444444-4444-4444-4444-444444444444', 'Metro', 'm', true),
  ('u5555555-5555-5555-5555-555555555555', 'Juego', 'jgo', true),
  ('u6666666-6666-6666-6666-666666666666', 'Par', 'par', true)
ON CONFLICT DO NOTHING;
...
INSERT INTO clientes (id, tipo_persona, nombre, apellido, razon_social, cuil_cuit, email, telefono, celular, direccion, localidad, provincia, activo, es_recurrente, tipo_recurrente, frecuencia_compra_dias, frecuencia_compra_compras, frecuencia_compra_monto, cupo_credito, saldo_pendiente, limite_credito_negro, saldo_credito_negro, categoria_cliente, acepta_email, acepta_whatsapp, acepta_promociones, bloqueado, observaciones, puntos_acumulados, puntos_disponibles) VALUES
  ...
  ('cl666666-6666-6666-6666-666666666666', 'juridica', '', '', 'Constructora del Sol S.A.', '30-66778899-0', 'compras@constructsol.com', '011-4000-7777', '011-15-6789-7777', 'Av. Lugones 3400', 'CABA', 'Buenos Aires', true, true, 'manual', 30, 6, 180000, 200000, 45000, 0, 0, 'A', true, true, false, false, 'Paga a 30 días', 0, 0)
...
-- 19. COMPRAS
INSERT INTO compras (id, numero, id_proveedor, fecha, fecha_entrega, observaciones, estado, items, total, costo_envio, activo) VALUES
  ('co111111-1111-1111-1111-111111111111', 2001, 'p1111111-1111-1111-1111-111111111111', NOW() - INTERVAL '10 days', NOW() - INTERVAL '2 days', 'Pedido habitual de Bosch', 'recibido', '[{"id_producto":"pr333333-3333-3333-3333-333333333333","nombre":"Pastillas de Freno Bosch BP978","cantidad":10,"precio_unitario":18000,"total":180000},{"id_producto":"pr444444-4444-4444-4444-444444444444","nombre":"Batería Bosch S4 12V 60Ah","cantidad":5,"precio_unitario":65000,"total":325000}]'::jsonb, 505000, 5000, true),
  ('co222222-2222-2222-2222-222222222222', 2002, 'p2222222-2222-2222-2222-222222222222', NOW() - INTERVAL '20 days', NOW() - INTERVAL '5 days', 'Aceite para stock', 'recibido', '[{"id_producto":"pr111111-1111-1111-1111-111111111111","nombre":"Aceite de Motor 15W-40 Mineral 4L","cantidad":30,"precio_unitario":28500,"total":855000}]'::jsonb, 855000, 2500, true),
  ('co333333-3333-3333-3333-333333333333', 2003, 'p3333333-3333-3333-3333-333333333333', NOW() - INTERVAL '5 days', NOW() + INTERVAL '3 days', 'Neumáticos flota', 'pendiente', '[{"id_producto":"pr555555-5555-5555-5555-555555555555","nombre":"Neumático Michelin Primacy 4","cantidad":8,"precio_unitario":95000,"total":760000}]'::jsonb, 760000, 7500, true)
ON CONFLICT DO NOTHING;

-- 20. FACTURAS ELECTRÓNICAS
INSERT INTO facturas_electronicas (id, numero, tipo, id_cliente, cliente_nombre, fecha, total, estado) VALUES
  ('fe111111-1111-1111-1111-111111111111', '001-00001001', 'factura', 'cl111111-1111-1111-1111-111111111111', 'Carlos González', NOW() - INTERVAL '2 days', 42000, 'aprobada'),
  ('fe222222-2222-2222-2222-222222222222', '001-00001002', 'factura', 'cl222222-2222-2222-2222-222222222222', 'María Fernández', NOW() - INTERVAL '5 days', 8900, 'aprobada'),
  ('fe333333-3333-3333-3333-333333333333', '001-00001003', 'factura', 'cl333333-3333-3333-3333-333333333333', 'Transportes Rápidos S.A.', NOW() - INTERVAL '8 days', 87000, 'aprobada'),
  ('fe444444-4444-4444-4444-444444444444', '001-00001004', 'factura', 'cl111111-1111-1111-1111-111111111111', 'Carlos González', NOW() - INTERVAL '12 days', 168000, 'aprobada'),
  ('fe555555-5555-5555-5555-555555555555', '001-00001005', 'nota_credito', 'cl333333-3333-3333-3333-333333333333', 'Transportes Rápidos S.A.', NOW() - INTERVAL '15 days', 15000, 'aprobada')
ON CONFLICT DO NOTHING;

-- 21. CAMPAÑAS
INSERT INTO campanias (id, nombre, tipo, descripcion, beneficio, fecha_desde, fecha_hasta, estado, condicion, activo) VALUES
  ('cam11111-1111-1111-1111-111111111111', 'Verano 2025', 'descuento', 'Campaña promocional de verano', '20% de descuento', NOW() - INTERVAL '15 days', NOW() + INTERVAL '30 days', 'activa', 'Todos los productos', true),
  ('cam22222-2222-2222-2222-222222222222', 'Día del Mecánico', 'descuento', 'Descuento especial', '15% de descuento', NOW() - INTERVAL '5 days', NOW() + INTERVAL '10 days', 'activa', 'Compra mínima $50000', true),
  ('cam33333-3333-3333-3333-333333333333', 'Hot Sale', 'puntos_dobles', 'Acumulá el doble de puntos', '2x puntos', NOW() - INTERVAL '20 days', NOW() - INTERVAL '5 days', 'finalizada', 'Todos los productos', true)
ON CONFLICT DO NOTHING;
...
INSERT INTO configuracion_alertas (codigo_alerta, nombre, activo, tipo, prioridad, condicion_tipo, mensaje_titulo, mensaje_cuerpo) VALUES
  ('STOCK_MIN', 'Alerta de Stock Mínimo', true, 'stock', 'alta', 'stock_actual <= stock_minimo', 'Stock bajo', 'El producto tiene stock por debajo del mínimo'),
  ('CREDITO_VENC', 'Crédito Vencido', true, 'cobro', 'urgente', 'saldo_pendiente > 0 AND dias_vencido > 30', 'Crédito vencido', 'El cliente tiene deuda vencida'),
  ('ORDEN_LISTA', 'Orden Lista para Entregar', true, 'servicio', 'media', 'estado = listo', 'Orden lista', 'La orden está lista para retirar')
